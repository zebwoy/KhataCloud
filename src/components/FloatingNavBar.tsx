        ...
        <div className="flex items-center justify-around py-2 px-2">
          ...
          {!trialMode ? (
            ...
            <button
              type="button"
              onClick={handleTrialSignOut}
              className="flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-xl text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 transition-colors whitespace-nowrap active:scale-95"
              title="Sign Out"
            >
              <LogOut size={14} />
